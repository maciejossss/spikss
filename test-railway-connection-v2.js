...
// Railway PostgreSQL connection using the connection string from manage-db.bat
const client = new Client({
  connectionString: 'postgresql://postgres:RejcVvKxoptptXgEpWDDwuKBDwgokfwb@shuttle.proxy.rlwy.net:15442/railway',
  ssl: { rejectUnauthorized: false }
});

async function testRailwayConnectionV2() {
  try {
    console.log('🔍 Łączenie z bazą danych Railway PostgreSQL (v2)...');
    console.log('📡 Próba połączenia z:', 'postgresql://postgres:***@shuttle.proxy.rlwy.net:15442/railway');
    ...
    console.error('❌ Błąd podczas łączenia z bazą danych Railway (v2):');
